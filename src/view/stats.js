...
export default class HeaderStats extends SmartView  {
  constructor(points) {
    super();

    this._data = points;

    this._pricesChart = null;
    this._typesChart = null;
    this._timsChart = null;
  ...
  removeElement() {
    ...
    if (this._pricesChart !== null || this._typesChart !== null || this._timsChart !== null) {
      this._pricesChart = null;
      this._typesChart = null;
      this._timsChart = null;
    }
  ...
  _setCharts() {
    ...
    this._pricesChart = renderMoneyChart(moneyCtx, this._data);
    this._typesChart = renderTypeChart(typeCtx, this._data);
    this._timsChart = renderTimsChart(timeCtx, this._data);
  }
}
